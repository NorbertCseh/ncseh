...
const Navbar = ({ color, setColor }: setColorProps) => {
    return (
        <nav className="flex items-center h-16 justify-between px-20 sticky top-0 z-50 border-b-2 bg-indigo-50 border-indigo-500 dark:border-indigo-500 dark:bg-indigo-900">
